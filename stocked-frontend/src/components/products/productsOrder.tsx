...
import {ProductOrderInterface, ProviderDeliveryTimes, ProviderOptionType} from "../../intefaces";
import ProviderSelector from "../providers/providerSelector";
import moment from "moment";

const placeholderDate = moment().add(2, 'days').format('YYYY-MM-DD');

const ProductOrder: React.FC<ProductOrderInterface> = (props: ProductOrderInterface) => {
    const {
        onOpen,
        onClose,
        open,
    ...
    }, [dispatch, loading, onClose, provider, shipmentsCreateData, shipmentsCreateProgress, t]);
